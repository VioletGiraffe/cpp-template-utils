...
///////////////////////////////////////////////////////////////////////////////
// Local patch: no trailing ';' - it comes from the call site, which would otherwise be left with an empty statement (-Wextra-semi-stmt). Fixed upstream in Catch2 v3.
